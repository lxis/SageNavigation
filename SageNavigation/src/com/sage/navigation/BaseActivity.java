...
public class BaseActivity extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		String resultTypeText = bundle
				.getString(TransferDataConstant.ResultType);
	 ...
	 */
	public void go(Class NavigateClass, Object Param,
			HashMap<Class, CommonSimpleHandlerGenic<Object>> handlers) {
		Intent intent = new Intent(this, NavigateClass);
		Bundle b = new Bundle();
		b.putString(TransferDataConstant.NavigateParam,
				new Gson().toJson(Param));
		intent.putExtras(b);

		Iterator<Entry<Class, CommonSimpleHandlerGenic<Object>>> entryKeyIterator = handlers
				.entrySet().iterator();
		while (entryKeyIterator.hasNext()) {
			Entry<Class, CommonSimpleHandlerGenic<Object>> e = entryKeyIterator
					.next();
	...
	public void setResult(Object object) {
		...
		bundle.putString(TransferDataConstant.FromType, this.getClass()
				.getName());
		bundle.putString(TransferDataConstant.ResultType,
				new Gson().toJson(object.getClass()));
	...
	public <T> T getParam(Class<T> classType) {
		return new Gson().fromJson(
				getIntent().getExtras().getString(
						TransferDataConstant.NavigateParam), classType);
	}
}
